...
<a id="x-28LOG4CL-EXTRAS-2FCHANGELOG-3A-3A-7C0-2E12-2E0-7C-2040ANTS-DOC-2FLOCATIVES-3ASECTION-29"></a>
...
Macro [`log4cl-extras/secrets:with-secrets`][fa0e] was added. It allows to solve the problem with passing secret values right into the third party libraries which do not support `secret-values:secret-value` objects.
