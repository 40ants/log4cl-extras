...
### [function](50d1) `log4cl-extras/config:setup` config
...
### [class](e55d) `log4cl-extras/plain:plain-layout` (layout)

<a id="x-28LOG4CL-EXTRAS-2FJSON-3AJSON-LAYOUT-20CLASS-29"></a>

### [class](8a35) `log4cl-extras/json:json-layout` (layout)
...
### [macro](1865) `log4cl-extras/context:with-fields` (&rest fields) &body body
...
### [function](b826) `log4cl-extras/context:get-fields`
...
### [variable](2f8d) `log4cl-extras/error:*max-traceback-depth*` 10
...
### [variable](0af0) `log4cl-extras/error:*max-call-length*` 100

<a id="x-28LOG4CL-EXTRAS-2FERROR-3A-2AARGS-FILTERS-2A-20-28VARIABLE-29-29"></a>

### [variable](5124) `log4cl-extras/error:*args-filters*` nil
...
### [macro](8034) `log4cl-extras/error:with-log-unhandled` (&key (depth \*max-traceback-depth\*)) &body body
...
### [function](2587) `log4cl-extras/error:print-backtrace` &key (stream \*debug-io\*) (condition nil) (depth \*max-traceback-depth\*) (max-call-length \*max-call-length\*) (args-filters \*args-filters\*)
...
### [function](47e7) `log4cl-extras/error:make-args-filter` predicate placeholder
...
### [class](cc09) `log4cl-extras/error:placeholder` ()
...
### [function](aba4) `log4cl-extras/error:make-placeholder` name
...
### [function](6545) `log4cl-extras/error:placeholder-p` obj
...
### [reader](d434) `log4cl-extras/error:placeholder-name` (placeholder) (:name)
...
### [function](c8c0) `log4cl-extras/secrets:make-secrets-replacer`
...
[50d1]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/config.lisp#L211
[b826]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/context.lisp#L62
[1865]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/context.lisp#L78
[2f8d]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/error.lisp#L148
[0af0]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/error.lisp#L150
[5124]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/error.lisp#L152
[2587]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/error.lisp#L254
[8034]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/error.lisp#L303
[cc09]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/error.lisp#L317
[d434]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/error.lisp#L318
[aba4]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/error.lisp#L336
[6545]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/error.lisp#L351
[47e7]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/error.lisp#L355
[8a35]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/json.lisp#L54
[e55d]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/plain.lisp#L77
[c8c0]: https://github.com/40ants/log4cl-extras/blob/299ef2369a881e0c7dd98658d51f2abcc571d4ce/src/secrets.lisp#L350
